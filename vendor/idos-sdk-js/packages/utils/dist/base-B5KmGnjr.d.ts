import { AddAddressMessageToSign, AddAddressSignatureMessage, RemoveAddressMessageToSign, RemoveAddressSignatureMessage } from "./types-BfDSer2T.js";
import { z } from "zod";
...
declare abstract class BaseProvider<K extends EnclaveOptions = EnclaveOptions> {
  ...
  */
  ...
  addAddressMessageToSign(_address: string, _publicKey: string | undefined, _addressToAddType: string): Promise<AddAddressMessageToSign>;
  removeAddressMessageToSign(_address: string, _publicKey: string | undefined, _addressToRemoveType: string): Promise<RemoveAddressMessageToSign>;
  addAddressToMpcSecret(_userId: string, _message: AddAddressSignatureMessage, _signature: string): Promise<string>;
  removeAddressFromMpcSecret(_userId: string, _message: RemoveAddressSignatureMessage, _signature: string): Promise<string>;
}
//#endregion
...
//# sourceMappingURL=base-B5KmGnjr.d.ts.map