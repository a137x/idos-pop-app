...
var BaseProvider = class {
	...
	*/
	setSigner(signer) {
		if (signer.signTypedData) this._signMethod = signer.signTypedData.bind(signer);
	...
	async signTypedData(domain, types, value) {
		if (!this._signMethod) throw new Error("Signer is not set");
...
//# sourceMappingURL=keys-BYTM9ukg.js.map